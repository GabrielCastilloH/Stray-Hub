...
export default function CameraScreen() {
  ...
  function handleDeletePress(id: string) {
    Alert.alert(
      'Delete Photo',
      'Remove this photo from the session?',
      [
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      {/* Viewfinder */}
      <View style={[styles.viewfinderOuter, { borderColor: qualityColor + '66' }]}>
      ...
      <View style={styles.thumbnailContainer}>
        {photos.length === 0 ? (
          <Text style={styles.thumbnailEmpty}>Captured photos will appear here</Text>
        ) : (
          <ScrollView
            horizontal
